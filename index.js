...
app.get("/movies", async(request, response) => {
  ...
  const movie=await client.db("test").collection("movie").find(request.query).toArray();
  response.send(movie);
});
...
app.post("/movies",express.json(),async (request, response) => {
  ...
  console.log(data);
  const movie = await client.db("test").collection('movie').insertMany(data)
  response.send(movie);
})
// app.get("/newmovies", express.json(), async (request, response) => {
